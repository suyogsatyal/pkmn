...
function PokemonList() {
    ...
    return (
        <div className="py-4">
            ...
            <h3 className="pokedex text-center text-lg md:text-xl text-gray-600">Made using <a href="pokeapi.co" className=" text-blue-400">PokeApi</a></h3>
                ...
                {pokemonList.map((pokemon, index) => (
                    <a href="#" key={pokemon.name} className="flex flex-col items-center px-1 sm:px-3 overflow-hidden bg-[conic-gradient(at_top_right,_var(--tw-gradient-stops))] from-normal to-fire rounded-md">
                        ...
                        <div className="flex flex-row items-center">
                            <img className="md:w-32 md:h-32 w-24 h-24 z-10" src={`https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/dream-world/${index + offset + 1}.svg`} />
